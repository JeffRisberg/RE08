                    ...
                    <div className="row">
                        ...
                        {(self.props.displayButtons === "true") ?
                            <div className="col-md-4" style={{textAlign: 'right'}}>
                                ...
                                <button onClick={ () => {self.props.displayUpdateDonation(donation)}}>Update Donation</button>
...
Donations.propTypes = {
    displayButtons: React.PropTypes.bool,
    showCharityAddress: React.PropTypes.bool,
    showCharityEin: React.PropTypes.bool
};
